...
public class App {
    ...
    private static void run() {
        final String projectAbsolutePath = System.getProperty("user.dir");
        boolean run = true;
        System.out.println("Welcome to custom classloader");
        System.out.println("Please enter path in project folder to load class from or 'exit' to close the programm.");
        while(run) {
            System.out.println("");
            ...
            if (input.equals(EXIT_COMMAND)) {
                ...
                System.out.println("");
                load(projectAbsolutePath + "\\" + input + "\\");
            }
        }
    }
